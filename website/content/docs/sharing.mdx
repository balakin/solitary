...
solitary clone dm-balakin/cells            # a catalogue, unnamed: lists what is in it
```
...
```text
$ solitary clone dm-balakin/cells
github.com/dm-balakin/cells holds 3 cells:
  claude
  go
  rust
Take one with: solitary clone github.com/dm-balakin/cells#claude
```
...
```text
Cell "claude" from github.com/dm-balakin/cells
...
```sh
solitary clone dm-balakin/cells/claude --as work
```
...
```sh
solitary clone dm-balakin/cells/claude --force
```
