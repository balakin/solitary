...
- Nothing inside a cell can open a page on your machine. A cell has no path to the host, so a sign-in that works by launching a browser has nothing to launch. Authenticate on the host and pass the credential in as a secret.
