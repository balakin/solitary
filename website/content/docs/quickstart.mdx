...
<Cards>
  <Card title="The configuration reference" href="/docs/configuration" />
  <Card title="Restrict what it can reach" href="/docs/guides-network-policy" />
  <Card title="Manage cells in a live view" href="/docs/dashboard" />
</Cards>
