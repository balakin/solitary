...
curl -fsSL -o solitary.tar.gz \
  "https://github.com/dm-balakin/solitary/releases/latest/download/solitary_${OS}_${ARCH}.tar.gz"
tar -xzf solitary.tar.gz solitary
install -m 755 solitary /usr/local/bin/solitary
```

`solitary --version` prints the version that was baked in at build time. The [release page](https://github.com/dm-balakin/solitary/releases/latest) lists every archive and the changelog for the version.
