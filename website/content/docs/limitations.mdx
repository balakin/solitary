...
The project is still pre-alpha. Interfaces, configuration shape, and platform support can change. Installation and operational documentation are pending; do not rely on it for production security decisions yet.
